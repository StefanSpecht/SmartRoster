 ...
 * @author Daniel Dyer
 */
public class RosterCrossover extends AbstractCrossover<Roster>
{
    /**
     * Default is single-point cross-over, applied to all parents.
     */
    public RosterCrossover()
    {
        this(1);
    }
     ...
     */
    public RosterCrossover(int crossoverPoints)
    {
     ...
     */
    public RosterCrossover(int crossoverPoints, Probability crossoverProbability)
    {
     ...
     */
    public RosterCrossover(NumberGenerator<Integer> crossoverPointsVariable)
    {
