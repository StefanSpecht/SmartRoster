 ...
 * @author Daniel Dyer
 */
public class UniformAdvancedRosterCrossover extends AbstractCrossover<Roster>
{
    /**
     * Default is single-point cross-over, applied to all parents.
     */
    public UniformAdvancedRosterCrossover()
    {
        this(1);
    }
     ...
     */
    public UniformAdvancedRosterCrossover(int crossoverPoints)
    {
     ...
     */
    public UniformAdvancedRosterCrossover(int crossoverPoints, Probability crossoverProbability)
    {
     ...
     */
    public UniformAdvancedRosterCrossover(NumberGenerator<Integer> crossoverPointsVariable)
    {
